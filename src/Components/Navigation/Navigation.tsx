...
const Navigation = () => {
    ...
    return (
        <>
            <div className="h-screen w-60 fixed top-0 left-0 bg-[#181818] z-99">
                <div className="flex flex-col items-center justify-between h-full">
                    ...
                    <div className="w-full p-6">
                        <Link to={'/users'} replace className="w-full py-3 px-3 flex gap-x-3 items-center text-white text-sm rounded-lg hover:bg-[#282828] cursor-pointer">
                        ...
                        <Link to={'/areas'} className="w-full py-3 px-3 flex gap-x-3 items-center text-white text-sm rounded-lg hover:bg-[#282828] cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="currentColor" viewBox="0 -960 960 960">
                    ...
                    {/* Footer | Log Out */}
                    <div className="w-full p-6">
                        <button onClick={handleLogout} className="w-full py-3 px-3 flex gap-x-3 items-center text-white text-sm rounded-lg hover:bg-[#282828] cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-7" fill="currentColor" viewBox="0 -960 960 960">
